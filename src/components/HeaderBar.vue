<template>
  <div class="header-bar">
    <h1 class="title">
      <router-link :to="{ name: 'HomePage'}">豆瓣</router-link>
    </h1>
    <ul class="nav">
      <li>
      ...
      <li>
        <router-link :to="{ name: 'StatusPage'}" style="color: #e4a813">广播</router-link>
      </li>
      <li>
        <router-link :to="{ name: 'GroupPage'}" style="color: #2ab8cc">小组</router-link>
      </li>
    </ul>
    <span class="talion" v-on:click="showTalion"></span>
  </div>
</template>
